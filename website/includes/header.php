        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="adminNavbarContent">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php"><i class="bi bi-globe me-1"></i>View Site</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0" style="border-radius: var(--border-radius-md);">
                            ...
                            <li><a class="dropdown-item py-2 text-danger" href="index.php"><i class="bi bi-box-arrow-right me-2"></i>Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
